...
require_once 'vendor/crudbooster/assets/filemanager-files/includes/include/utils.php';
    ...
    switch ($_GET['action']) {
        ...
        case 'change_lang':
            ...
            if (array_key_exists($choosen_lang, $languages)) {
                if (! file_exists('vendor/crudbooster/assets/filemanager-files/includes/lang/' . $choosen_lang . '.php')) {
                    response(trans('Lang_Not_Found').AddErrorLocation())->send();
                    exit;
                } else {
