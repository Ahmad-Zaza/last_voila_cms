...
if ( ! function_exists('trans'))
{
	...
	*/
	...
	if ( ! isset($_SESSION['RF']['language'])
		|| file_exists('vendor/crudbooster/assets/filemanager-files/includes/lang/' . basename($_SESSION['RF']['language']) . '.php') === false
		|| ! is_readable('vendor/crudbooster/assets/filemanager-files/includes/lang/' . basename($_SESSION['RF']['language']) . '.php')
	)
	{
	...
	{
		if(file_exists('vendor/crudbooster/assets/filemanager-files/includes/lang/languages.php')){
			$languages = include 'vendor/crudbooster/assets/filemanager-files/includes/lang/languages.php';
		}else{
			$languages = include '../vendor/crudbooster/assets/filemanager-files/includes/lang/languages.php';
		}
	...
	if(file_exists('vendor/crudbooster/assets/filemanager-files/includes/lang/' . $lang . '.php')){
		$lang_vars = include 'vendor/crudbooster/assets/filemanager-files/includes/lang/' . $lang . '.php';
	}else{
		$lang_vars = include '../vendor/crudbooster/assets/filemanager-files/includes/lang/' . $lang . '.php';
	}
...
function ftp_con($config){
	if(isset($config['ftp_host']) && $config['ftp_host']){
		// *** Include the class
		include('vendor/crudbooster/assets/filemanager-files/includes/include/FtpClient.php');
		include('vendor/crudbooster/assets/filemanager-files/includes/include/FtpException.php');
		include('vendor/crudbooster/assets/filemanager-files/includes/include/FtpWrapper.php');
