...
function OpenInsertImage(moduleNameparm, id) {
    ...
    $("#modalInsertPhoto .modal-body").html(`<iframe width="100%" height="400" src="{{Route('dialog')}}?type=2&field_id=list_images" frameborder="0" style="overflow: scroll; overflow-x: hidden; overflow-y: scroll; "></iframe>`);
...
function deleteImageList(e) {
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            var result = arr[0] + "//" + arr[2] + '/backend/';
            $("#show-images").html('');
